  ...
  return (
    <div className="rounded-[1.5rem] border border-white/60 bg-white/85 p-5 shadow-sm sm:rounded-[2.5rem] sm:p-8">
      <div className="flex flex-col justify-between gap-5 border-b border-black/10 pb-6 sm:gap-6 sm:pb-8 md:flex-row md:items-start">
        <div><p className="text-sm" style={{ color: "var(--page-soft)" }}>订单编号</p><h2 className="font-display mt-2 break-all text-2xl leading-tight sm:text-5xl" style={{ color: "var(--page-ink)" }}>{order.id}</h2><p className="mt-3 sm:mt-4" style={{ color: "var(--page-soft)" }}>当前状态：<span style={{ color: "var(--page-ink)" }}>{current.label}</span></p></div>
