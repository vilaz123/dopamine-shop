  ...
  return (
    ...
    <section className="container-shell py-10 sm:py-16">
      ...
      <div className="mt-8 grid grid-cols-1 gap-4 sm:gap-6 sm:mt-10 md:grid-cols-3">
        <div className="dopamine-panel rounded-[1.5rem] p-5 sm:rounded-[2rem] sm:p-7"><p className="text-sm text-white/75">虚拟钱包</p><p className="font-display mt-2 break-words text-4xl sm:text-5xl">{coins} 币</p></div>
