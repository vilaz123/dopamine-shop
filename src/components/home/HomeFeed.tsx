    ...
    <>
      <section className="theme-home relative overflow-hidden">
        ...
        <div className="container-shell relative grid min-h-[78vh] items-center gap-12 py-20 lg:grid-cols-[1.05fr_.95fr]">
          <div>
            <p className="mb-6 text-xs uppercase tracking-[0.38em]" style={{ color: "var(--page-ink)" }}>Dopahub 多巴胺仓</p>
            <h1 className="font-display max-w-4xl text-6xl leading-[.88] md:text-8xl" style={{ color: "var(--page-ink)" }}>虚拟下单，真实不付款。</h1>
            <p className="mt-8 max-w-xl text-lg leading-8" style={{ color: "var(--page-soft)" }}>复刻浏览、加购、满减、物流与晒单的快感，把扣款痛苦完全抹除。库存有限，物流永远在路上。</p>
      ...
      <section className="theme-home relative overflow-hidden py-20">
        <div className="page-paint absolute inset-0 -z-10" aria-hidden />
        <div className="container-shell">
          <p className="text-xs uppercase tracking-[0.32em]" style={{ color: "var(--page-ink)" }}>For You</p>
          <h2 className="font-display mt-3 text-5xl" style={{ color: "var(--page-ink)" }}>为你推荐</h2>
        ...
        <div className="container-shell">
          <div className="mb-10 flex items-end justify-between">
            <div>
              ...
              <h2 className="font-display mt-3 text-5xl" style={{ color: "var(--page-ink)" }}>虚拟外卖专区</h2>
            </div>
