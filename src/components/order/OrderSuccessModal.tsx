...
export function OrderSuccessModal({ coins, xp, badges, onClose }: { coins: number; xp: number; badges: string[]; onClose: () => void }) {
  return (
    <div className="fixed inset-0 z-[60] grid place-items-center bg-black/45 p-4">
      <div className="relative max-w-lg overflow-hidden rounded-[1.5rem] bg-white p-6 text-center shadow-2xl sm:rounded-[2.5rem] sm:p-8">
        ...
        <div className="relative">
          ...
          <h2 className="font-display mt-3 text-4xl sm:text-6xl">下单成功！</h2>
