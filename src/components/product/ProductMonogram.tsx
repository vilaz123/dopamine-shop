...
export function ProductMonogram({ product, large = false, priority = false }: { product: Product; large?: boolean; priority?: boolean }) {
  ...
  return (
    <div
      ...
      style={{
        background: `radial-gradient(circle at 22% 15%, rgba(255,255,255,.52), transparent 25%), radial-gradient(circle at 82% 25%, ${product.saturation}, transparent 24%), linear-gradient(135deg, ${product.saturation}, #241A4D 78%)`,
      }}
    >
